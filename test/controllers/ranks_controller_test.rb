...
class RanksControllerTest < ActionController::TestCase
  ...
  test "should create rank" do
    assert_difference('Rank.count') do
      post :create, rank: { played: @rank.played, rank: @rank.rank, score: @rank.score, user_id: @rank.user_id }
    end
  ...
  test "should update rank" do
    patch :update, id: @rank, rank: { played: @rank.played, rank: @rank.rank, score: @rank.score, user_id: @rank.user_id }
    assert_redirected_to rank_path(assigns(:rank))
  end
